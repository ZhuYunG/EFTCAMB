...
FFLAGS =  -O3 -llapack -lblas -fopenmp -ffast-math -fmax-errors=4 -ffree-line-length-none -funroll-loops -cpp -ffpe-summary=none -fallow-invalid-boz -std=legacy -fbounds-check -fcheck=all
